...
<p style="margin-left: 50px">
   <img src="docs/images/install1.png" alt="Installation Step 1" width="800px">
</p>

3. Enter the URL `https://github.com/christianjianelli/yaai_cloud_rest.git`:

<p style="margin-left: 50px">
   <img src="docs/images/install2.png" alt="Installation Step 2" width="500px">
</p>

4. Specify the package:

<p style="margin-left: 50px">
   <img src="docs/images/install3.png" alt="Installation Step 3" width="500px">
</p>

5. Click the **Finish** button:

<p style="margin-left: 50px">
   <img src="docs/images/install4.png" alt="Installation Step 4" width="500px">
</p>

6. Activate the imported objects as needed.
